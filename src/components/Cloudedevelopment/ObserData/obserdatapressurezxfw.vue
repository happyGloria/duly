    ...
    <vue-scroll>
      <div class="contentoutbox">
        <div class="contentinbox">
          <!-- conten1 -->
          <div class="contentoutbox_contentbox1">压力监测数据置信范围分析</div>
          <!-- conten2 -->
          <div class="contentoutbox_contentbox2">
            ...
            <div class="contentoutbox_contentbox2_textbox">
              ...
              >压力监测数据置信范围分析是根据压力监测点的历史数据，计算当前时刻的数据置信区间。如果监测点连续多个时间点的数据超出置信区间，则认为该监测点发生异常并报警。</div>
            </div>
            <div class="contentoutbox_contentbox2_img">
              <img
                src="../../../assets/img/service_zhixin02.png"
                style="width:100%"
                alt
              >
            </div>
            ...
            <div class="contentoutbox_contentbox6_textbox">
              <table class="contentoutbox_contentbox6_table">
                ...
                <tr>
                  ...
                  <td>输入历史窗口</td>
                  <td>N*1</td>
                  <td>建议取30天的数据作为历史窗口。须保证历史窗口内的数据在时间上连续，如果某一时刻缺数据，补充为NaN值。</td>
                </tr>
                <tr class="alt">
                  <td>Day_count</td>
                  <td>历史窗口数据天数</td>
      ...
      "Limit_up":339
          ...
          <div class="contentoutbox_contentbox10">
            ...
            <div class="contentoutbox_contentbox10_textbox">
              <textarea name id cols="100" rows="30" v-model="messageobserdatapressurezxfw" placeholder></textarea>
            </div>
          ...
          <div class="contentoutbox_contentbox11">
            ...
            <div class="contentoutbox_contentbox11_textbox">
              <textarea name id cols="100" rows="30" v-model="resmsgobserdatapressurezxfw" readonly></textarea>
            </div>
          </div>
          <!-- conten12 echarts部分 -->
          <div class="contentoutbox_contentbox12">
           <!--  <obserdatapressurezxfwecharts/> -->
          </div>
          <!-- content结束 -->
        </div>
      </div>
...
/* import obserdatapressurezxfwecharts from "@/components/Cloudedevelopment/ObserData/echarts/obserdatapressurezxfwecharts" */
export default {
  name: "obserdatapressurezxfw",
 /*  components:{
    obserdatapressurezxfwecharts
  }, */
  data() {
    return {
      messageobserdatapressurezxfw: JSON.stringify(defalftdata.obserdatapressurezxfwdata),
      resmsgobserdatapressurezxfw: JSON.stringify(defalftdata.obserdatapressurezxfwresdata),
       messageobserdatapressurezxfw2: {...defalftdata.obserdatapressurezxfwdata},
    };
  },
  mounted() {},
  methods: {
    Sim_per_cal() {
      var params = this.messageobserdatapressurezxfw;
      this.$axios
        .post(Urlclass.UrlclassData_wash_f + "/Simpercal/Sim_per_cal", params)
        .then(res => {
          var that = this;
          that.resmsgobserdatapressurezxfw =JSON.stringify(res.data);
          var resdata=res.data
          var params2=that.messageobserdatapressurezxfw2
          var washdata={params2,resdata}
          Bus.$emit("obserdatapressurezxfwfun", washdata);
        })
        .catch(err => {
          console.log("连接数据库失败！");
        });
