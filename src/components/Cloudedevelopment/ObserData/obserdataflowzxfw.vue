    ...
    <vue-scroll>
      <div class="contentoutbox">
        <div class="contentinbox">
          <!-- conten1 -->
          <div class="contentoutbox_contentbox1">流量监测数据置信范围分析</div>
          <!-- conten2 -->
          <div class="contentoutbox_contentbox2">
            ...
            <div class="contentoutbox_contentbox2_textbox">
              ...
              >流量监测数据置信范围分析是根据流量监测点的历史数据，计算当前时刻的数据置信区间。如果监测点连续多个时间点的数据超出置信区间，则认为该监测点发生异常并报警。 该算法也可以用于分区水量异常报警，当分区水量连续多个时间点超过置信区间上限，则认为该分区发生异常并报警。</div>
            </div>
            <div class="contentoutbox_contentbox2_img">
              <img
                src="../../../assets/img/service_zhixin.png"
                style="width:100%"
                alt
              >
            </div>
      ...
      "Limit_up":339
          ...
          <div class="contentoutbox_contentbox10">
            ...
            <div class="contentoutbox_contentbox10_textbox">
              <textarea name id cols="100" rows="30" v-model="messageobserdataflowzxfw" placeholder></textarea>
            </div>
          ...
          <div class="contentoutbox_contentbox11">
            ...
            <div class="contentoutbox_contentbox11_textbox">
              <textarea name id cols="100" rows="30" v-model="resmsgobserdataflowzxfw" readonly></textarea>
            </div>
          </div>
          <!-- conten12 echarts部分 -->
          <div class="contentoutbox_contentbox12">
           <!--  <obserdataflowzxfwecharts/> -->
          </div>
          <!-- content结束 -->
        </div>
      </div>
...
/* import obserdataflowzxfwecharts from "@/components/Cloudedevelopment/ObserData/echarts/obserdataflowzxfwecharts" */
export default {
  name: "obserdataflowzxfw",
 /*  components:{
    obserdataflowzxfwecharts
  }, */
  data() {
    return {
      messageobserdataflowzxfw: JSON.stringify(defalftdata.obserdataflowzxfwdata),
      resmsgobserdataflowzxfw: JSON.stringify(defalftdata.obserdataflowzxfwresdata),
       messageobserdataflowzxfw2: {...defalftdata.obserdataflowzxfwdata},
    };
  },
  mounted() {},
  methods: {
    Sim_per_cal() {
      var params = this.messageobserdataflowzxfw;
      this.$axios
        .post(Urlclass.UrlclassData_wash_f + "/Simpercal/Sim_per_cal", params)
        .then(res => {
          var that = this;
          that.resmsgobserdataflowzxfw =JSON.stringify(res.data);
          var resdata=res.data
          var params2=that.messageobserdataflowzxfw2
          var washdata={params2,resdata}
          Bus.$emit("obserdataflowzxfwfun", washdata);
        })
        .catch(err => {
          console.log("连接数据库失败！");
        });
