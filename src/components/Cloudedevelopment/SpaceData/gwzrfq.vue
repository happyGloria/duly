    ...
    <vue-scroll>
      <div class="contentoutbox">
        <div class="contentinbox">
          <!-- conten1 -->
          <div class="contentoutbox_contentbox1">管网自然分区计算</div>
          <!-- conten2 -->
          <div class="contentoutbox_contentbox2">
            ...
            <div class="contentoutbox_contentbox2_textbox">
              ...
              >管网自然分区计算是根据管网的节点坐标和拓扑信息，对管网节点进行分析，计算管网有多少个相互独立的区域，并给每个节点按分区进行编号。</div>
            </div>
            <div class="contentoutbox_contentbox2_img">
              <img
                src="../../../assets/img/service_ziranfenqu.png"
                style="width:100%"
                alt
              >
            </div>
 ...
 -->
          ...
          <div class="contentoutbox_contentbox10">
            ...
            <div class="contentoutbox_contentbox10_textbox">
              <textarea name id cols="100" rows="30" v-model="messagegwzrfq" placeholder></textarea>
            </div>
          ...
          <div class="contentoutbox_contentbox11">
            ...
            <div class="contentoutbox_contentbox11_textbox">
              <textarea name id cols="100" rows="30" v-model="resmsggwzrfq" readonly></textarea>
            </div>
          </div>
          <!-- conten12 echarts部分 -->
...
/* import gwzrfqecharts from "@/components/Cloudedevelopment/ObserData/echarts/gwzrfqecharts" */
export default {
  name: "gwzrfq",
 /*  components:{
    gwzrfqecharts
  ...
  data() {
    return {
      messagegwzrfq: JSON.stringify(defalftdata.gwzrfqdata),
      resmsggwzrfq: JSON.stringify(defalftdata.gwzrfqresdata),
       messagegwzrfq2: {...defalftdata.gwzrfqdata},
    };
  },
  mounted() {},
  methods: {
    Sim_per_cal() {
      var params = this.messagegwzrfq;
      this.$axios
        .post(Urlclass.UrlclassData_wash_f + "/Simpercal/Sim_per_cal", params)
        .then(res => {
          var that = this;
          that.resmsggwzrfq =JSON.stringify(res.data);
          var resdata=res.data
          var params2=that.messagegwzrfq2
          var washdata={params2,resdata}
          Bus.$emit("gwzrfqfun", washdata);
        })
        .catch(err => {
          console.log("连接数据库失败！");
        });
