    ...
    <vue-scroll>
      <div class="contentoutbox">
        <div class="contentinbox">
          <!-- conten1 -->
          <div class="contentoutbox_contentbox1">查找接近的节点</div>
          <!-- conten2 -->
          <div class="contentoutbox_contentbox2">
            ...
            <div class="contentoutbox_contentbox2_textbox">
              ...
              >查找接近的节点是根据管网模型的节点坐标和拓扑信息，设定一个节点间距离阈值，找出模型中距离小于距离阈值的节点对。 可用于对管网模型的简化。</div>
            </div>
            <div class="contentoutbox_contentbox2_img">
              <img
                src="../../../assets/img/service_zhixin02 (1).png"
                style="width:100%"
                alt
              >
            </div>
          ...
          <div class="contentoutbox_contentbox5">
            ...
            <div class="contentoutbox_contentbox5_textbox">
              <div class="contentoutbox_contentbox5_text">
                网址
                <a
                  href="http://112.64.170.158:9102/dis_node_pair.asmx/Dis_node_pair"
                >http://112.64.170.158:9102/dis_node_pair.asmx/Dis_node_pair</a>
              </div>
            </div>
          </div>
           <!-- conten5add -->
        <!--   <div class="contentoutbox_contentbox5add">
            ...
            <div class="contentoutbox_contentbox5add_textbox">
                <div class="contentoutbox_contentbox5add_text">
                 需选取不少于一天的历史数据。
两个监测点的历史数据需在时间上相对应。
在进行处理之前，可以用window_wash_p或window_wash_f对历史窗口进行清洗，有利于提高计算效果。
                </div>
            </div>
          </div> -->
          <!-- conten6 -->
...
{
        "Dis_max" : 0.01 , 
        "X" :[ 102085.12 , 103816.48 , ...... ] , 
        "Y" :[ 48933.1 , 40376.9 ,,40254.57, ...... ]  
       }
          ...
          <div class="contentoutbox_contentbox8">
           ...
           <!--  <div class="contentoutbox_contentbox8_img">
              <img src="../../../assets/img/pathbiao.png" style="width:100%" alt>
            </div> -->
          </div>
          <!-- conten9 -->
          <div class="contentoutbox_contentbox9">
            ...
            <div class="contentoutbox_contentbox9_textbox">
              <textarea name id cols="100" rows="30" readonly>
{"a" :[ 7 , 15 ,16 ,22 ,28 ,51 ,56 ,56 ,60 ,60 ,60 ,60 ,62 ,62 , ...... ] , "b" :[ 1147 , 2690 ,1021,1021, ...... ]}
 ...
 <!-- conten9add -->
         <!--  <div class="contentoutbox_contentbox6">
            <div class="contentoutbox_contentbox6_title">数据信息</div>
            <div class="contentoutbox_contentbox6_textbox">
              <table class="contentoutbox_contentbox6_table">
                <tr>
                  <th>Path维度</th>
               ...
               3
                  ...
                  <td>Inf</td>
                  <td>终止节点不在输入的管网信息内</td>
                </tr>
                <tr class="alt">
                <td>1*1</td>
                <td>4</td>
                <td>Inf</td>
                <td>节点信息不包含全部的管道节点</td>
                </tr>
                  <tr>
                  <td>1*1</td>
                  <td>
                5
                  ...
                  <td>Inf</td>
                  <td>起始节点到终止节点无连通路径</td>
                </tr>
                <tr class="alt">
                <td>K*1（K≥2)</td>
                <td></td>
                <td></td>
                <td>Path(1)为 Nodesta，Path(end)为 Nodeend</td>
                </tr>
 ...
 -->
          ...
          <div class="contentoutbox_contentbox10">
            ...
            <div class="contentoutbox_contentbox10_textbox">
              <textarea name id cols="100" rows="30" v-model="messagesearchpointed" placeholder></textarea>
            </div>
          <!--   <div @click="Sim_per_cal" class="contentoutbox_contentbox10_djyx">点击运行</div> -->
          ...
          <div class="contentoutbox_contentbox11">
            ...
            <div class="contentoutbox_contentbox11_textbox">
              <textarea name id cols="100" rows="30" v-model="resmsgsearchpointed" readonly></textarea>
            </div>
          </div>
          <!-- conten12 echarts部分 -->
          <div class="contentoutbox_contentbox12">
           <!--  <searchpointedecharts/> -->
          </div>
          <!-- content结束 -->
        </div>
      </div>
...
/* import searchpointedecharts from "@/components/Cloudedevelopment/ObserData/echarts/searchpointedecharts" */
export default {
  name: "searchpointed",
 /*  components:{
    searchpointedecharts
  ...
  data() {
    return {
      messagesearchpointed: JSON.stringify(defalftdata.searchpointeddata),
      resmsgsearchpointed: JSON.stringify(defalftdata.searchpointedresdata),
       messagesearchpointed2: {...defalftdata.searchpointeddata},
    };
  },
  mounted() {},
  methods: {
    Sim_per_cal() {
      var params = this.messagesearchpointed;
      this.$axios
        .post(Urlclass.UrlclassData_wash_f + "/Simpercal/Sim_per_cal", params)
        .then(res => {
          var that = this;
          that.resmsgsearchpointed =JSON.stringify(res.data);
          var resdata=res.data
          var params2=that.messagesearchpointed2
          var washdata={params2,resdata}
          Bus.$emit("searchpointedfun", washdata);
        })
        .catch(err => {
          console.log("连接数据库失败！");
        });
