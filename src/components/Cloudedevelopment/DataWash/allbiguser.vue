    ...
    <vue-scroll>
      <div class="contentoutbox">
        <div class="contentinbox">
          <!-- conten1 -->
          <div class="contentoutbox_contentbox1">批量大用户监测数据清洗</div>
          <!-- conten2 -->
          <div class="contentoutbox_contentbox2">
            ...
            <div class="contentoutbox_contentbox2_textbox">
              ...
              >批量大用户监测数据清洗是对一段时间的大用户监测数据进行清洗，删除明显超出正常范围的数据，对短时间的缺失数据进行补充，如果长时间数据缺失，不对其进行补充。</div>
            </div>
            <div class="contentoutbox_contentbox2_img">
              <img
                src="../../../assets/img/service_piliangdayonghuqingxi.png"
                style="width:100%"
                alt
              >
            </div>
          ...
          <div class="contentoutbox_contentbox5">
            ...
            <div class="contentoutbox_contentbox5_textbox">
              <div class="contentoutbox_contentbox5_text">
                网址
                <a
                  href="http://112.64.170.158:9100/api/Windowwashuser/Window_wash_user"
                >http://112.64.170.158:9100/api/Windowwashuser/Window_wash_user</a>
              </div>
            </div>
          </div>
          <!-- conten6 -->
      ...
      "History_window_out":[157,141,.......]
          ...
          <div class="contentoutbox_contentbox10">
            ...
            <div class="contentoutbox_contentbox10_textbox">
              <textarea name id cols="100" rows="30" v-model="messageallbiguser" placeholder></textarea>
            </div>
            <div @click="Window_wash_user" class="contentoutbox_contentbox10_djyx">点击运行</div>
          </div>
          <!-- conten11 -->
          <div class="contentoutbox_contentbox11">
            ...
            <div class="contentoutbox_contentbox11_textbox">
              <textarea name id cols="100" rows="30" v-model="resmsgallbiguser" readonly></textarea>
            </div>
          </div>
          <!-- conten12 echarts部分 -->
...
import allbiguserecharts from "@/components/Cloudedevelopment/DataWash/echarts/allbiguserecharts"
export default {
  name: "allbiguser",
  components:{
   allbiguserecharts
  ...
  data() {
    return {
      messageallbiguser: JSON.stringify(defalftdata.allbiguserdata),
      resmsgallbiguser: JSON.stringify(defalftdata.allbiguserresdata),
       messageallbiguser2: {...defalftdata.allbiguserdata},
    };
  },
  mounted() {},
  methods: {
    Window_wash_user() {
      var params = this.messageallbiguser;
      this.$axios
        .post(Urlclass.UrlclassData_wash_f + "/Windowwashuser/Window_wash_user", params)
        .then(res => {
          var that = this;
          that.resmsgallbiguser =JSON.stringify(res.data);
          var resdata=res.data
          var params2=that.messageallbiguser2
          var washdata={params2,resdata}
          Bus.$emit("washdatafunallbiguser", washdata);
        })
        .catch(err => {
          console.log("连接数据库失败！");
        });
